...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7273505353780844549L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"hadoop.avro.examples\",\"doc\":\"A pair of strings.\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
   ...
   */
  public static hadoop.avro.examples.StringPair.Builder newBuilder() {
    return new hadoop.avro.examples.StringPair.Builder();
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static hadoop.avro.examples.StringPair.Builder newBuilder(hadoop.avro.examples.StringPair.Builder other) {
    return new hadoop.avro.examples.StringPair.Builder(other);
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static hadoop.avro.examples.StringPair.Builder newBuilder(hadoop.avro.examples.StringPair other) {
    return new hadoop.avro.examples.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(hadoop.avro.examples.StringPair.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(hadoop.avro.examples.StringPair other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public hadoop.avro.examples.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public hadoop.avro.examples.StringPair.Builder clearLeft() {
      left = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public hadoop.avro.examples.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public hadoop.avro.examples.StringPair.Builder clearRight() {
      right = null;
